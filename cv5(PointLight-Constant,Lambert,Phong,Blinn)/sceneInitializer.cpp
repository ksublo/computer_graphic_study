...
SceneInitializer::SceneInitializer() : camera(nullptr), light(nullptr){
}
...
void SceneInitializer::initializeScene1(Scene& scene1) {
    ...
    addBushObjects(scene1, shaderProgram, model2);
...
void SceneInitializer::inicializeScene2(Scene& scene2)
{
    ...
    light = new Light(LightType::POINT, glm::vec3(0.0f, 0.0f, 0.4f), glm::vec3(0.5f, 0.5f, 1.0f), 1.0f);
...
void SceneInitializer::inicializeScene3(Scene& scene3)
{
    ...
    light = new Light(LightType::POINT, glm::vec3(-0.5f, 2.0f, 3.0f), glm::vec3(0.5f, 0.5f, 1.0f), 1.0f);

    shaderProgramConstant->setLight(light);
    shaderProgramLambert->setLight(light);
    shaderProgramPhong->setLight(light);
    shaderProgramBlinn->setLight(light);
}
...
void SceneInitializer::setLight(Light* light)
{
    this->light = light;
}

DrawableObject* SceneInitializer::createDrawableObjectWithTransform(Object* object, ShaderProgram* shaderProgram, float translationX, float translationY, float translationZ, float rotationAngle, float rotationX, float rotationY, float rotationZ, float scaleValue)
{
    DrawableObject* drawableObject = new DrawableObject(object, shaderProgram);
